...
class Settings(BaseSettings):
    ...
    ALGORITHM: str = "HS256"
    DISABLE_AUTH: bool = (
        False  # Flaga do wyłączenia autoryzacji podczas pracy deweloperskiej
    )
    ...
    SLURM_LOG_LEVEL: str = (
        "ERROR"  # Temporarily set to ERROR to disable most SLURM logs
    )
    ...
    SIMULATION_OUTPUT_DIR: str = os.getenv(
        "SIMULATION_OUTPUT_DIR",
        "/mnt/local/kkingstoun/admin/pcss_storage/mannga/amu_cont_amumax_dir",
    )
