    ...
    return {
        "JobCreate": {
            ...
            "properties": {
                ...
                "partition": {
                    "type": "string",
                    "description": "Partycja SLURM",
                    "default": "gpu",
                },
                "num_cpus": {
                    "type": "integer",
                    "description": "Liczba CPU",
                    "default": 4,
                },
                "memory_gb": {
                    "type": "integer",
                    "description": "Pamięć RAM w GB",
                    "default": 16,
                },
                "num_gpus": {
                    "type": "integer",
                    "description": "Liczba GPU",
                    "default": 1,
                },
                "max_time_hours": {
                    "type": "integer",
                    "description": "Maksymalny czas w godzinach",
                    "default": 24,
                },
                "script_content": {
                    "type": "string",
                    "description": "Treść skryptu (opcjonalne)",
                },
            },
        },
        "TaskCreate": {
            ...
            "properties": {
                ...
                "simulation_file": {
                    "type": "string",
                    "description": "Ścieżka do pliku symulacji",
                },
                "partition": {
                    "type": "string",
                    "description": "Partycja SLURM",
        ...
        "CLITokenCreate": {
            ...
            "properties": {
                ...
                "expires_days": {
                    "type": "integer",
                    "description": "Wygaśnięcie w dniach",
                    "default": 30,
                },
            },
        },
    ...
    return [
        {
            ...
            "requirements": {"min_gpus": 1, "min_memory_gb": 8, "min_cpus": 2},
            "parameters": {
                "input_file": {
                    "required": True,
                    "type": "file",
                    "description": "Input .mx3 file",
                },
                "output_dir": {
                    "required": False,
                    "type": "string",
        ...
        },
        {
            ...
            "requirements": {"min_gpus": 0, "min_memory_gb": 4, "min_cpus": 1},
            "parameters": {
                "notebook_file": {
                    "required": False,
                    "type": "file",
