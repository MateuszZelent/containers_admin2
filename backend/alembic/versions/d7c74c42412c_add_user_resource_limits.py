...
def upgrade():
    ...
    op.create_index(
        op.f("ix_cli_tokens_token_hash"), "cli_tokens", ["token_hash"], unique=True
    )
    op.create_table(
        "queue_jobs",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_task_queue_jobs_id"), "task_queue_jobs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_task_queue_jobs_slurm_job_id"),
        "task_queue_jobs",
        ["slurm_job_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_task_queue_jobs_task_id"), "task_queue_jobs", ["task_id"], unique=True
    )
    op.add_column(
        "cluster_status", sa.Column("response_time_ms", sa.Integer(), nullable=True)
    )
    op.add_column(
        "cluster_status", sa.Column("active_jobs_count", sa.Integer(), nullable=True)
    )
    op.alter_column(
        "cluster_status",
        "id",
    ...
    op.alter_column(
        "cluster_status", "is_connected", existing_type=sa.BOOLEAN(), nullable=True
    )
    op.alter_column(
        "cluster_status", "last_check", existing_type=sa.DATETIME(), nullable=True
    )
    op.create_index(
    ...
    op.add_column(
        "slurm_job_snapshots", sa.Column("exit_code", sa.Integer(), nullable=True)
    )
    op.add_column(
        "slurm_job_snapshots",
        sa.Column(
    ...
    op.alter_column(
        "slurm_job_snapshots", "job_id", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "slurm_job_snapshots",
        "node_count",
    ...
    op.add_column(
        "ssh_tunnels", sa.Column("external_port", sa.Integer(), nullable=True)
    )
    op.add_column(
        "ssh_tunnels", sa.Column("internal_port", sa.Integer(), nullable=True)
    )
...
def downgrade():
    ...
    op.create_index(
        "ix_slurm_job_snapshots_user", "slurm_job_snapshots", ["user"], unique=False
    )
    op.alter_column(
        "slurm_job_snapshots",
        "is_current",
    ...
    op.alter_column(
        "slurm_job_snapshots", "job_id", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "slurm_job_snapshots",
        "id",
    ...
    op.alter_column(
        "cluster_status", "last_check", existing_type=sa.DATETIME(), nullable=False
    )
    op.alter_column(
        "cluster_status", "is_connected", existing_type=sa.BOOLEAN(), nullable=False
    )
    op.alter_column(
        "cluster_status",
        "id",
