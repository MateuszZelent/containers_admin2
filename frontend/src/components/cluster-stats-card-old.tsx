  ...
  return (
    <Card className="hover:shadow-md transition-shadow">
      ...
      <CardContent className="space-y-6">
        {stats && summary?.status === 'ok' ? (
          <>
            {/* Nodes Section - Updated for new format */}
            <div className="space-y-3">
              <div className="flex items-center gap-2">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-green-50 rounded-lg p-3">
                  ...
                  <div className="text-xs text-green-600">Wolne</div>
                </div>
                <div className="bg-blue-50 rounded-lg p-3">
                  <div className="text-xl font-bold text-blue-700">
                    {summary.nodes.busy}
                  </div>
                  <div className="text-xs text-blue-600">Zajęte</div>
                </div>
                <div className="bg-red-50 rounded-lg p-3">
                  <div className="text-xl font-bold text-red-700">
                    {summary.nodes.unavailable}
                  </div>
                  <div className="text-xs text-red-600">Niedostępne</div>
                </div>
              </div>
              <div className="bg-gray-50 rounded-lg p-3">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Całkowicie</div>
                  </div>
                  <div className="text-right">
                    <div className={`text-lg font-bold ${getUtilizationColor(summary.nodes.utilization_percent)}`}>
                      {summary.nodes.utilization_percent}%
                    </div>
            ...
            {/* GPU Section - Updated for new format */}
            <div className="space-y-3">
              <div className="flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-green-50 rounded-lg p-3">
                  ...
                  <div className="text-xs text-green-600">
                    Wolne (active: {summary.gpus.active}, standby: {summary.gpus.standby})
                  </div>
                </div>
                <div className="bg-blue-50 rounded-lg p-3">
                  <div className="text-xl font-bold text-blue-700">
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <div className={`text-lg font-bold ${getUtilizationColor(summary.gpus.utilization_percent)}`}>
            ...
            <div className="flex items-center justify-between pt-4 border-t">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <Calendar className="h-4 w-4" />
                <span>
                  Ostatnia aktualizacja: {new Date(summary.timestamp).toLocaleString()}
                </span>
              </div>
            </div>
          </>
          ...
          <div className="flex items-center justify-center py-8">
            <div className="text-center">
              <AlertCircle className="h-12 w-12 text-red-500 mx-auto mb-4" />
              <p className="text-red-600 font-medium">Error loading cluster statistics</p>
              <p className="text-sm text-gray-500 mt-2">{summary.message}</p>
            </div>
          </div>
        ) : (
          <div className="flex items-center justify-center py-8">
            <div className="text-center">
              ...
              <p className="text-yellow-600 font-medium">No cluster data available</p>
              <p className="text-sm text-gray-500 mt-2">Please check cluster connection</p>
            </div>
          </div>
        )}
      </CardContent>
